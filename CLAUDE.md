...
`claude mcp list` health check takes ~6.9s wall-clock (median of 3 runs, 6.5-7.0s), including the
...
- **Verification status of the four keys above.** Two are behaviourally verified. With
  ...
  **2.1.245** reports "No installation issues found." (the only note is the expected Remote Control
