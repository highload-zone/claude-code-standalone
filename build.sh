...
echo "   edit tools/package.json, then regenerate the lockfile inside node:20:"
echo "   docker run --rm -v \"\$PWD/tools:/w\" -w /w node:20-bookworm-slim npm install --package-lock-only"
echo ""
